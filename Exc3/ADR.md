...
|UC6| система кол-центра, сотрудник кол-центра (менеджер), пользователь| менеджер обрабатывает заявку на депозит | <ol> <li> Менеджер разбирает входящие заявки на депозиты от клиентов </li><li> При изучении заявки может согласовать особые условия.</li><li> Менеджер звонит клиенту (пользователю) для согласования деталей открытия депозита</li>|
